...
public class TicTacToeServer {
    ...
    public void onOpen(Session session, @PathParam("gameId") long gameId,
        ...
        try {
            TicTacToeGame ticTacToeGame = TicTacToeGame.getActiveGame(gameId); // 判断游戏有没有开始
    ...
    public void onMessage(Session session, String message,
        ...
        try {
            ...
            game.ticTacToeGame.move(
                    isPlayer1 ? TicTacToeGame.Player.PLAYER1 : TicTacToeGame.Player.PLAYER2,
                    move.getRow(),
                    move.getColumn()
            );
            ...
            if (game.ticTacToeGame.isOver()) {
                if (game.ticTacToeGame.isDraw()) { // 平局
